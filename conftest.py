...
from tests.utils import ARBITRARY_BBOX, ARBITRARY_EXTENT, ARBITRARY_GEOM, TestCases
...
def projection_landsat8_item() -> Item:
    ...
    return Item.from_file(str(path))


def get_data_file(rel_path: str) -> str:
    return str(TESTS_DIR / "data-files" / rel_path)
