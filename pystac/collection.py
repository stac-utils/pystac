...
from pystac import catalog, errors
from pystac import link as link_mod
from pystac import provider, rel_type, stac_object
...
class Collection(catalog.Catalog):
    ...
    def __init__(
        ...
        extra_fields: Optional[Dict[str, Any]] = None,
        catalog_type: Optional[catalog.CatalogType] = None,
        ...
        super().__init__(
            ...
            extra_fields,
            href,
            catalog_type or catalog.CatalogType.ABSOLUTE_PUBLISHED,
        )
        self.extent = extent
    ...
    def from_dict(
        ...
        catalog_type = catalog.CatalogType.determine_type(d)
        ...
        for link in links:
            ...
            if link["rel"] != rel_type.RelType.SELF or href is None:
                collection.add_link(link_mod.Link.from_dict(link))
