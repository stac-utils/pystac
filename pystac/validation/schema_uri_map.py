...
class DefaultSchemaUriMap(SchemaUriMap):
    ...
    # the schema.
    BASE_URIS: List[Tuple[identify.STACVersionRange, Callable[[str], str]]] = [
        (
            identify.STACVersionRange(min_version="1.0.0-beta.2"),
            lambda version: "https://schemas.stacspec.org/v{}".format(version),
        ),
        (
            identify.STACVersionRange(min_version="0.8.0", max_version="1.0.0-beta.1"),
            lambda version: (
...
class OldExtensionSchemaUriMap:
    ...
    def get_base_uris(
        ...
        Tuple[identify.STACVersionRange, Callable[[identify.STACVersionID], str]]
    ]:
        return [
            (
                identify.STACVersionRange(min_version="1.0.0-beta.2"),
            ...
            (
                identify.STACVersionRange(
                    min_version="0.8.0", max_version="1.0.0-beta.1"
                ),
                lambda version: (
    ...
    def get_schema_map(cls) -> Dict[str, Any]:
        return {
            ...
            identify.OldExtensionShortIDs.COLLECTION_ASSETS.value: (
                {
                    STACObjectType.COLLECTION: (
            ...
            identify.OldExtensionShortIDs.DATACUBE.value: (
                {
                    STACObjectType.COLLECTION: (
                ...
                [
                    (
                        identify.STACVersionRange(
                            min_version="0.5.0", max_version="0.9.0"
                        ),
                        {
            ...
            identify.OldExtensionShortIDs.ITEM_ASSETS.value: (
                {
                    STACObjectType.COLLECTION: (
            ...
            identify.OldExtensionShortIDs.LABEL.value: (
                ...
                [
                    (
                        identify.STACVersionRange(
                            min_version="0.8.0-rc1", max_version="0.8.1"
                        ),
            ...
            identify.OldExtensionShortIDs.SCIENTIFIC.value: (
                {
                    STACObjectType.ITEM: (
            ...
            identify.OldExtensionShortIDs.SINGLE_FILE_STAC.value: (
                {
                    STACObjectType.CATALOG: (
            ...
            identify.OldExtensionShortIDs.TILED_ASSETS.value: (
                {
                    STACObjectType.CATALOG: (
            ...
            identify.OldExtensionShortIDs.VERSION.value: (
                {
            ...
            "asset": (
                ...
                [
                    (
                        identify.STACVersionRange(
                            min_version="0.8.0-rc1", max_version="0.9.0"
                        ),
                        {
                            STACObjectType.COLLECTION: (
    ...
    def _append_base_uri_if_needed(
        cls, uri: str, stac_version: identify.STACVersionID
    ) -> Optional[str]:
        # Only append the base URI if it's not already an absolute URI
        if "://" not in uri:
    ...
    def get_extension_schema_uri(
        ...
        stac_version: identify.STACVersionID,
    ) -> Optional[str]:
        uri = None
