...
def collection() -> Collection:
    return Collection.from_file( TestCases.get_path(
...
def test_off_nadir(item: Item) -> None:
    ...
    assert  ViewExtension.ext(asset_no_prop).off_nadir == ViewExtension.ext(item).off_nadir
...
def test_incidence_angle(item: Item) -> None:
    ...
    asset_no_prop = item.assets["blue"]
    asset_prop = item.assets["red"]
    assert  ViewExtension.ext(asset_no_prop).incidence_angle == ViewExtension.ext(item).incidence_angle
...
def test_sun_azimuth(item: Item) -> None:
    ...
    asset_no_prop = item.assets["blue"]
    asset_prop = item.assets["red"]
    assert  ViewExtension.ext(asset_no_prop).sun_azimuth == ViewExtension.ext(item).sun_azimuth
...
def test_sun_elevation(item: Item) -> None:
    ...
    asset_no_prop = item.assets["blue"]
    asset_prop = item.assets["red"]
    assert  ViewExtension.ext(asset_no_prop).sun_elevation == ViewExtension.ext(item).sun_elevation
