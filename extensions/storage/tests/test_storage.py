...
NAIP_EXAMPLE_URI = str(DATA_FILES / "item-naip.json")
NAIP_COLLECTION_URI = str(DATA_FILES / "collection-naip.json")
V1_MIGRATION_ITEM_URI = str(DATA_FILES / "item-v1.0.0.json")
