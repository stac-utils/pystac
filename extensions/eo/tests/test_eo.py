...
LANDSAT_EXAMPLE_URI = get_data_file("eo/eo-landsat-example.json")
BANDS_IN_ITEM_URI = get_data_file("eo/sample-bands-in-item-properties.json")
EO_COLLECTION_URI = get_data_file("eo/eo-collection.json")
S2_ITEM_URI = get_data_file("eo/eo-sentinel2-item.json")
