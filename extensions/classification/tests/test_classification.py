...
LANDSAT_EXAMPLE_URI = get_data_file(
    "classification/classification_landsat_example.json"
)
CLASSIFICATION_COLLECTION_RASTER_URI = get_data_file(
    "classification/collection-item-assets-raster-bands.json"
)
