...
SRALGSD = TypedDict("SRALGSD", {"along-track": int, "across-track": int})
SLSTRGSD = TypedDict("SLSTRGSD", {"S1-S6": int, "S7-S9 and F1-F2": int})
...
class Sentinel3Extension(
    ...
    def product_type(self, v: str | None) -> None:
        self._set_str(PRODUCT_TYPE_PROP, v)

    @property
    def product_name(self) -> str | None:
        return self._get_str(PRODUCT_NAME_PROP)

    @product_name.setter
    def product_name(self, v: str | None) -> None:
        self._set_str(PRODUCT_NAME_PROP, v)

    @property
    def processing_timeliness(self) -> str | None:
        return self._get_str(PROCESSING_TIMELINESS_PROP)

    @processing_timeliness.setter
    def processing_timeliness(self, v: str | None) -> None:
        self._set_str(PROCESSING_TIMELINESS_PROP, v)
    ...
    def lrm_mode(self) -> float | None:
        return self._get_float(LRM_MODE_PROP)

    @lrm_mode.setter
    def lrm_mode(self, v: float | None) -> None:
        self._set_float(LRM_MODE_PROP, v)

    @property
    def sar_mode(self) -> float | None:
        return self._get_float(SAR_MODE_PROP)

    @sar_mode.setter
    def sar_mode(self, v: float | None) -> None:
        self._set_float(SAR_MODE_PROP, v)

    @property
    def bright(self) -> float | None:
        return self._get_float(BRIGHT_PROP)

    @bright.setter
    def bright(self, v: float | None) -> None:
        self._set_float(BRIGHT_PROP, v)

    @property
    def closed_sea(self) -> float | None:
        return self._get_float(CLOSED_SEA_PROP)

    @closed_sea.setter
    def closed_sea(self, v: float | None) -> None:
        self._set_float(CLOSED_SEA_PROP, v)

    @property
    def coastal(self) -> float | None:
        return self._get_float(COASTAL_PROP)

    @coastal.setter
    def coastal(self, v: float | None) -> None:
        self._set_float(COASTAL_PROP, v)

    @property
    def continental_ice(self) -> float | None:
        return self._get_float(CONTINENTAL_ICE_PROP)

    @continental_ice.setter
    def continental_ice(self, v: float | None) -> None:
        self._set_float(CONTINENTAL_ICE_PROP, v)

    @property
    def cosmetic(self) -> float | None:
        return self._get_float(COSMETIC_PROP)

    @cosmetic.setter
    def cosmetic(self, v: float | None) -> None:
        self._set_float(COSMETIC_PROP, v)

    @property
    def dubious_samples(self) -> float | None:
        return self._get_float(DUBIOUS_SAMPLES_PROP)

    @dubious_samples.setter
    def dubious_samples(self, v: float | None) -> None:
        self._set_float(DUBIOUS_SAMPLES_PROP, v)

    @property
    def duplicated(self) -> float | None:
        return self._get_float(DUPLICATED_PROP)

    @duplicated.setter
    def duplicated(self, v: float | None) -> None:
        self._set_float(DUPLICATED_PROP, v)

    @property
    def fresh_inland_water(self) -> float | None:
        return self._get_float(FRESH_INLAND_WATER_PROP)

    @fresh_inland_water.setter
    def fresh_inland_water(self, v: float | None) -> None:
        self._set_float(FRESH_INLAND_WATER_PROP, v)

    @property
    def invalid(self) -> float | None:
        return self._get_float(INVALID_PROP)

    @invalid.setter
    def invalid(self, v: float | None) -> None:
        self._set_float(INVALID_PROP, v)

    @property
    def land(self) -> float | None:
        return self._get_float(LAND_PROP)

    @land.setter
    def land(self, v: float | None) -> None:
        self._set_float(LAND_PROP, v)

    @property
    def open_ocean(self) -> float | None:
        return self._get_float(OPEN_OCEAN_PROP)

    @open_ocean.setter
    def open_ocean(self, v: float | None) -> None:
        self._set_float(OPEN_OCEAN_PROP, v)

    @property
    def out_of_range(self) -> float | None:
        return self._get_float(OUT_OF_RANGE_PROP)

    @out_of_range.setter
    def out_of_range(self, v: float | None) -> None:
        self._set_float(OUT_OF_RANGE_PROP, v)

    @property
    def saline_water(self) -> float | None:
        return self._get_float(SALINE_WATER_PROP)

    @saline_water.setter
    def saline_water(self, v: float | None) -> None:
        self._set_float(SALINE_WATER_PROP, v)

    @property
    def saturated(self) -> float | None:
        return self._get_float(SATURATED_PROP)

    @saturated.setter
    def saturated(self, v: float | None) -> None:
        self._set_float(SATURATED_PROP, v)

    @property
    def tidal_region(self) -> float | None:
        return self._get_float(TIDAL_REGION_PROP)

    @tidal_region.setter
    def tidal_region(self, v: float | None) -> None:
        self._set_float(TIDAL_REGION_PROP, v)

    @property
    def snow_or_ice(self) -> float | None:
        return self._get_float(SNOW_OR_ICE_PROP)

    @snow_or_ice.setter
    def snow_or_ice(self, v: float | None) -> None:
        self._set_float(SNOW_OR_ICE_PROP, v)

    @property
    def shape(self) -> list[int] | None:
        return cast(list[int] | None, self._get_property(SHAPE_PROP, list))
    ...
    def altimetry_bands(self) -> list[AltimetryBand] | None:
        return cast(
            list[AltimetryBand] | None,
            self._get_property(ALTIMETRY_BANDS_PROP, list),
        )
...
class SummariesSentinel3Extension(SummariesExtension):
    ...
    def product_name(self) -> list[str] | None:
        return self._get_list(PRODUCT_NAME_PROP)
    ...
    def processing_timeliness(self) -> list[str] | None:
        return self._get_list(PROCESSING_TIMELINESS_PROP)
    ...
    def lrm_mode(self) -> RangeSummary[float] | None:
        return self._get_range(LRM_MODE_PROP)
    ...
    def sar_mode(self) -> RangeSummary[float] | None:
        return self._get_range(SAR_MODE_PROP)
    ...
    def bright(self) -> RangeSummary[float] | None:
        return self._get_range(BRIGHT_PROP)
    ...
    def closed_sea(self) -> RangeSummary[float] | None:
        return self._get_range(CLOSED_SEA_PROP)
    ...
    def coastal(self) -> RangeSummary[float] | None:
        return self._get_range(COASTAL_PROP)
    ...
    def continental_ice(self) -> RangeSummary[float] | None:
        return self._get_range(CONTINENTAL_ICE_PROP)
    ...
    def cosmetic(self) -> RangeSummary[float] | None:
        return self._get_range(COSMETIC_PROP)
    ...
    def dubious_samples(self) -> RangeSummary[float] | None:
        return self._get_range(DUBIOUS_SAMPLES_PROP)
    ...
    def duplicated(self) -> RangeSummary[float] | None:
        return self._get_range(DUPLICATED_PROP)
    ...
    def fresh_inland_water(self) -> RangeSummary[float] | None:
        return self._get_range(FRESH_INLAND_WATER_PROP)
    ...
    def invalid(self) -> RangeSummary[float] | None:
        return self._get_range(INVALID_PROP)
    ...
    def land(self) -> RangeSummary[float] | None:
        return self._get_range(LAND_PROP)
    ...
    def open_ocean(self) -> RangeSummary[float] | None:
        return self._get_range(OPEN_OCEAN_PROP)
    ...
    def out_of_range(self) -> RangeSummary[float] | None:
        return self._get_range(OUT_OF_RANGE_PROP)
    ...
    def saline_water(self) -> RangeSummary[float] | None:
        return self._get_range(SALINE_WATER_PROP)
    ...
    def saturated(self) -> RangeSummary[float] | None:
        return self._get_range(SATURATED_PROP)
    ...
    def tidal_region(self) -> RangeSummary[float] | None:
        return self._get_range(TIDAL_REGION_PROP)
    ...
    def snow_or_ice(self) -> RangeSummary[float] | None:
        return self._get_range(SNOW_OR_ICE_PROP)
