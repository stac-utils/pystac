...
FILE_ITEM_EXAMPLE_URI = str(DATA_FILES / "item.json")
FILE_EMPTY_ITEM_EXAMPLE_URI = str(DATA_FILES / "empty-item.json")
FILE_COLLECTION_EXAMPLE_URI = str(DATA_FILES / "collection.json")
...
@pytest.fixture
def ext_empty_item() -> Item:
    return Item.from_file(FILE_EMPTY_ITEM_EXAMPLE_URI)
