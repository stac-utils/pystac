...
from pystac import Asset, Collection, DataType, Item, ItemAssetDefinition
...
BASIC_MLM_ITEM_URI = str(DATA_FILES / "item_basic.json")
PLAIN_ITEM_URI = str(DATA_FILES / "item/sample-item.json")
MLM_COLLECTION_URI = str(DATA_FILES / "collection.json")
