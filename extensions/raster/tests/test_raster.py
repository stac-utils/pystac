...
SENTINEL2_EXAMPLE_URI = get_data_file("raster/raster-sentinel2-example.json")


LANDSAT_COLLECTION_EXAMPLE_URI = get_data_file("raster/landsat-collection-example.json")
...
def test_asset_bands(ext_item: pystac.Item) -> None:
    ...
    # new_histograms = []
    with open(get_data_file("raster/gdalinfo.json")) as gdaljson_file:
