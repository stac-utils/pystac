...
FILE_ITEM_EXAMPLE_URI = get_data_file("file/item.json")
FILE_COLLECTION_EXAMPLE_URI = get_data_file("file/collection.json")
FILE_CATALOG_EXAMPLE_URI = get_data_file("file/catalog.json")
