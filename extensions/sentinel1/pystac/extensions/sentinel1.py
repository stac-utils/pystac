...
class Sentinel1Extension(
    ...
    def processing_datetime(self) -> datetime | None:
        return map_opt(
            str_to_datetime,
            self._get_property(PROCESSING_DATETIME_PROP, str),
        )
...
class SummariesSentinel1Extension(SummariesExtension):
    ...
    def datatake_id(self) -> list[str] | None:
        return cast(list[str] | None, self.summaries.get_list(DATATAKE_ID_PROP))
    ...
    def instrument_configuration_id(self) -> list[str] | None:
        return cast(
            list[str] | None,
            self.summaries.get_list(INSTRUMENT_CONFIGURATION_ID_PROP),
        )
    ...
    def orbit_source(self) -> list[str] | None:
        return cast(list[str] | None, self.summaries.get_list(ORBIT_SOURCE_PROP))
    ...
    def resolution(self) -> list[str] | None:
        return cast(list[str] | None, self.summaries.get_list(RESOLUTION_PROP))
    ...
    def slice_number(self) -> list[str] | None:
        return cast(list[str] | None, self.summaries.get_list(SLICE_NUMBER_PROP))
    ...
    def total_slices(self) -> list[str] | None:
        return cast(list[str] | None, self.summaries.get_list(TOTAL_SLICES_PROP))
    ...
    def processing_level(self) -> list[str] | None:
        return cast(list[str] | None, self.summaries.get_list(PROCESSING_LEVEL_PROP))
    ...
    def shape(self) -> list[list[int]] | None:
        return cast(list[list[int]] | None, self.summaries.get_list(SHAPE_PROP))
