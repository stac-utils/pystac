...
def _validate_processing_baseline(v: str | None) -> str | None:
    ...
    if not PROCESSING_BASELINE_RE.match(v):
        raise ValueError(f"{PROCESSING_BASELINE_PROP} must match NN.NN. Got: {v}")
    return v
...
def _validate_percentage(prop: str, v: float | None) -> float | None:
    if v is None:
        return None
    if not 0 <= v <= 100:
        raise ValueError(f"{prop} must be between 0 and 100. Got: {v}")
    return v
...
class Sentinel2Extension(
    ...
    def granule_id(self, v: str | None) -> None:
        self._set_str(GRANULE_ID_PROP, v)
    ...
    def datatake_id(self, v: str | None) -> None:
        self._set_str(DATATAKE_ID_PROP, v)
    ...
    def product_uri(self, v: str | None) -> None:
        self._set_str(PRODUCT_URI_PROP, v)
    ...
    def datastrip_id(self, v: str | None) -> None:
        self._set_str(DATASTRIP_ID_PROP, v)
    ...
    def datatake_type(self, v: str | None) -> None:
        self._set_str(DATATAKE_TYPE_PROP, v)
    ...
    def water_percentage(self, v: float | None) -> None:
        self._set_float(WATER_PERCENTAGE_PROP, v)
    ...
    def mean_solar_zenith(self, v: float | None) -> None:
        self._set_float(MEAN_SOLAR_ZENITH_PROP, v)
    ...
    def mean_solar_azimuth(self, v: float | None) -> None:
        self._set_float(MEAN_SOLAR_AZIMUTH_PROP, v)
    ...
    def snow_ice_percentage(self, v: float | None) -> None:
        self._set_float(SNOW_ICE_PERCENTAGE_PROP, v)
    ...
    def vegetation_percentage(self, v: float | None) -> None:
        self._set_float(VEGETATION_PERCENTAGE_PROP, v)
    ...
    def thin_cirrus_percentage(self, v: float | None) -> None:
        self._set_float(THIN_CIRRUS_PERCENTAGE_PROP, v)
    ...
    def cloud_shadow_percentage(self, v: float | None) -> None:
        self._set_float(CLOUD_SHADOW_PERCENTAGE_PROP, v)
    ...
    def nodata_pixel_percentage(self, v: float | None) -> None:
        self._set_float(NODATA_PIXEL_PERCENTAGE_PROP, v)
    ...
    def unclassified_percentage(self, v: float | None) -> None:
        self._set_float(UNCLASSIFIED_PERCENTAGE_PROP, v)
    ...
    def dark_features_percentage(self, v: float | None) -> None:
        self._set_float(DARK_FEATURES_PERCENTAGE_PROP, v)
    ...
    def not_vegetated_percentage(self, v: float | None) -> None:
        self._set_float(NOT_VEGETATED_PERCENTAGE_PROP, v)
    ...
    def degraded_msi_data_percentage(self, v: float | None) -> None:
        self._set_float(DEGRADED_MSI_DATA_PERCENTAGE_PROP, v)
    ...
    def high_proba_clouds_percentage(self, v: float | None) -> None:
        self._set_float(HIGH_PROBA_CLOUDS_PERCENTAGE_PROP, v)
    ...
    def medium_proba_clouds_percentage(self, v: float | None) -> None:
        self._set_float(MEDIUM_PROBA_CLOUDS_PERCENTAGE_PROP, v)
    ...
    def saturated_defective_pixel_percentage(self, v: float | None) -> None:
        self._set_float(SATURATED_DEFECTIVE_PIXEL_PERCENTAGE_PROP, v)
    ...
    def reflectance_conversion_factor(self, v: float | None) -> None:
        self._set_float(REFLECTANCE_CONVERSION_FACTOR_PROP, v)
